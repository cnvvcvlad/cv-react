...
class Project extends Component {
  ...
  render() {
    ...
    let { name, languagesIcons, source, info, picture, urlAdress } = this.props.item
    ...
    return (
      <div className="project">
        ...
        <a href={picture} title="Image plein ecran">
          <h3>{name}</h3>
        </a>
          ...
          this.state.showInfo && (
            <div className="showInfos">
              <div className="infosContent">
                <div className="head">
                  <a
                    href={urlAdress ? urlAdress : '#'}
                    rel="noopener noreferrer"
                    target={urlAdress ? '_blank' : ''}
                    className=""
                    title={urlAdress ? 'Lien vers le site' : ''}
                  >
                    <h2>{name}</h2>
                  </a>
